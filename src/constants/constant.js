...
export const sectionArr = [
  {
    imgUrl: mobileImg,
    textContent: {
      heading: "Win a thousand Stars",
      article: `We’re giving away 1,000 Stars to 1,000 Starbucks® Rewards members in
our Million Stars Giveaway and much more all week!*`,
      class: "text-light",
    },
    btn: { children: "Play to win", class: "btn-lt-green" },
    reverse: false,
    center: true,
  },
  {
    imgUrl: peopleImg,
    textContent: {
      heading: "A new way to earn sips and trips",
      article: `Now you can link your Starbucks® Rewards + Delta SkyMiles® accounts to get:`,
      class: "text-light",
      listItems: [
    ...
    btn: { children: "Link accounts", class: "btn-lt-green" },
    reverse: true,
    center: false,
  },
  {
    imgUrl: mugImg,
    textContent: {
      heading: "Perfectly pumpkin",
      article: `Savor the season with a Pumpkin Spice Latte or Pumpkin Cream Cold Brew.`,
      class: "text-dark",
    },
    btn: { children: "Order now", class: "btn-dart-green" },
    reverse: false,
    center: true,
  },
  {
    ...
    textContent: {
      ...
      article: `Try the Apple Crisp Oatmilk Macchiato, now nondairy and with Starbucks® Blonde Espresso.`,
      class: "text-dark",
    },
    btn: { children: "Learn more", class: "btn-dart-green" },
    reverse: true,
    center: true,
  },
];
...
export const linksArr = [
  {
    heading: "About Us",
    links: [
      { text: "Our Company", url: "https://www.starbucks.com/about-us/" },
      { text: "Our Coffee", url: "https://www.starbucks.com/coffee/" },
      { text: "Stories and News", url: "https://stories.starbucks.com/" },
      { text: "Starbucks Archive", url: "https://archive.starbucks.com/" },
      {
        text: "Investor Relations",
        url: "https://investor.starbucks.com/ir-home/default.aspx",
      },
      {
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        url: "https://stories.starbucks.com/stories/inclusion-diversity/",
      },
      {
        text: "College Achievement Plan",
        url: "https://www.starbucks.com/careers/working-at-starbucks/education/",
      },
      { text: "Alumni Community", url: "https://alumni.starbucks.com/login/" },
      { text: "U.S. Careers", url: "https://www.starbucks.com/careers/" },
      {
  ...
  },
  {
    ...
    links: [
      ...
      {
        text: "Planet",
        url: "https://www.starbucks.com/responsibility/planet/",
      },
      {
  ...
  {
    heading: "For Business Partnersers",
    links: [
      {
  ...
  },
  {
    ...
    links: [
      ...
      { text: "Order on the Web", url: "https://www.starbucks.com/menu" },
      { text: "Delivery", url: "https://delivery.starbucks.com/" },
      {
